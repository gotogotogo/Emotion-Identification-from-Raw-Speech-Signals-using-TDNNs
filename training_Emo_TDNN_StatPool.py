...
### Data related
dataset_train = CustomDataset(args.raw_wav_path, mode='train', test_sess=5, duration=4)
...
dataset_test = CustomDataset(args.raw_wav_path, mode='test', test_sess=5, duration=4)
